...
module.exports = function phase5(test, s) {
    ...
    const methodTests = [
        ...
        ['ReflectPatch',         'actions/reflect-patch',          ['deployProposal']],
        ...
        ['ProviderHealth', 'router/health',   ['register', 'isAvailable', 'score', 'qualityScore', 'onSuccess', 'on429', 'onError', 'getSummary']],
        ...
        ['HealthAnalyzer',        'actions/health-analyzer', ['analyzeJournal', 'analyzeLog', 'analyzeProviders', 'analyzeReflections', 'formatReport']],
        ...
        ['VirtualCmdHandler',  'virtual-cmd-handler', ['run']],
